                ...
                <div class="form-group">
                    <ul class="list-group">
                       <li class="list-group-item"> 
                        ...
                        <select id="oldCourse" name="oldCourse">
                            @foreach($display as $courseInfo)
                            <option name="CourseCodeOld" value="{{ $courseInfo->courseCode }}">{{ $courseInfo->courseCode }}</option>
                            @endforeach
                        </select>

                        <button type="submit" class="btn btn-primary"> Swap Course </button>
                        {{ csrf_field() }}
                        </li>
                    </ul>
                </div>
